"""
Django settings for fourthmobileapp_5 project.
...
ROOT_URLCONF = 'fourthmobileapp_5.urls'
...
WSGI_APPLICATION = 'fourthmobileapp_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fourthmobileapp_5 API",
    "DESCRIPTION": "API documentation for fourthmobileapp_5 App",
    "VERSION": "v1",
}
